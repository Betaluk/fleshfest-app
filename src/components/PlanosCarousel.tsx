        ...
        {planos.map((plano, index) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-zinc-200 mb-2 sm:mb-3 font-[family-name:var(--font-jakarta)]">
                  Plano {plano.nome}
                </h3>

                <div className="flex items-baseline gap-1 mb-6 sm:mb-8">
                  <span className="text-base sm:text-lg text-zinc-500 font-medium">R$</span>
                  <span className="text-5xl sm:text-6xl font-extrabold text-white tracking-tighter font-[family-name:var(--font-jakarta)]">
                    {plano.preco}
                  </span>
                  <span className="text-xs sm:text-sm text-zinc-500 font-medium">/evento</span>
                </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-2">
        ...
        <div className="flex md:hidden items-center gap-3">
          <button
            ...
            disabled={!canScrollLeft}
            aria-label="Plano anterior"
            className="w-11 h-11 rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center text-white disabled:opacity-30 disabled:pointer-events-none active:scale-90 transition-transform"
          >
